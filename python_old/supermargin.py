...
_tperiod_ = "Tcy"    #set this variable to your tester period variable
_vddmax_  = "VCCval" #set this variable to your vdd max variable or to a voltage such as '5V'
TIMING    = 1        #set this to '0' for timing or to '1' for voltage
    ...
    for param in params:
        ...
        if (TIMING):
            ...
            if param==_vddmax_:#use nominal value to prevent circular dependency
                ...
                start_str = "0V"
                stop_str  = _vddmax_
        outstr += "\tRow = Axis { NumSteps = Expr { String = \"30\"; } ParameterVariance { Param "+param+";"+spaces+"Start = Expr { String = \""+start_str+"\"; } Stop = Expr { String = \""+stop_str+"\"; } PinGroup = Expr { String = \"ALLPINS\";}}}\n"
    #End for
