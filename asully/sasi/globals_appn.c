...
long readlinenum = 0, cpm_calling_dpm_count = 0, appr_vc = 0, countlines =
	0;
...
int SCAN = 0, lastwascont = 0, SCANCNT = 0;
...
int fieldcount[MXFIELD], fieldtype[MXFIELD], fieldstart[MXFIELD], fields =
	0, fhlen = 0;
int phd_st[MXFIELD], phd_sp[MXFIELD], cmma[MXFIELD];
char infile_base[READLINELEN + 1];
int RESULT_BAD;
struct SCAN_VECTORS *SCANV;
int BEGINCNT = 0, ENDCNT = 0, REPEATCNT = 0, MAXLOOPDEPTH = 0;
