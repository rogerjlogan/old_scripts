...
(*  THESE WAVEFORMS are for ADCINS, ADCIOS, ADCSOC, LVDOVRD, OSCBYPN, PMTMODE, VREFHI (not characterized) *)
  ...
  TIsearchACTable:
    begin
START(ALLENUMS,TIlofrqACTable,TIlofrqpllACTable,TIhifrqACTable,TIveryhifrqACTable,TIsearchACTable);
...
STOP(ALLENUMS,TIlofrqACTable,TIlofrqpllACTable,TIhifrqACTable,TIveryhifrqACTable,TIsearchACTable);
 ...
 TIPMT100ACTable:
    begin
START(ALLENUMS,TIlofrqlooseACTable,TIhifrqlooseACTable,TIveryhifrqlooseACTable,TIsearchlooseACTable,TIscanACTable,TIPMT100ACTable);
        WaveSetNR          (ABUSdriveWF,t[tref]+t[tH]);
        EdgeSetOrigin      (ABUSdriveWF,Edge1,orgclkoutll);
...
(* removed this WF to avoid glitches on PSN and STRBN *)
{
        ...
        EdgeSetOrigin      (XTAL2strobeWF,Edge2,orgclkin);
        EdgeSetOrigin      (XTAL2strobeWF,Edge3,orgclkin);
STOP(ALLENUMS,TIlofrqlooseACTable,TIhifrqlooseACTable,TIveryhifrqlooseACTable,TIsearchlooseACTable,TIscanACTable,TIPMT100ACTable);
    end;  (* end loose AC Tables *)

  TIsearchlooseACTable2:
    begin
START(ALLENUMS,TIsearchlooseACTable2);
        WaveSetNR          (ABUSdriveWF,t[tref]+t[tH]);
        EdgeSetOrigin      (ABUSdriveWF,Edge1,orgclkoutll);
...
(* removed this WF to avoid glitches on PSN and STRBN *)
{
        ...
        EdgeSetOrigin      (XTAL2strobeWF,Edge2,orgclkin);
        EdgeSetOrigin      (XTAL2strobeWF,Edge3,orgclkin);
STOP(ALLENUMS,TIsearchlooseACTable2);
