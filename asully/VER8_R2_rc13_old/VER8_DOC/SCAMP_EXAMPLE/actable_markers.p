...
begin
START(ALLTABLES,ALLDEVICES,ALLTESTS,Temp_N40_Degrees_C);
...
if PJQPack then
     begin 
START(ALLTABLES,PJQPack,ALLTESTS,ALLTEMPS);
   	WaveSetStrobe (C8SHFTCLK_strobeWF,
    	...
    	WaveSetStrobe (C16SHFTCLK_strobeWF,
        	...
        	( (3*t[Tcy]) div 4) ,
        	( (3*t[Tcy]) div 4) + 2*t[tShft] );
STOP(ALLTABLES,PJQPack,ALLTESTS,ALLTEMPS);
     end ;
if not PJQPack then
     begin 
START(ALLTABLES,ALLDEVICES-PJQPack,ALLTESTS,ALLTEMPS);
     	WaveSetStrobe (C8SHFTCLK_strobeWF,
        	( (3*t[Tcy]) div 4),
        	( (3*t[Tcy]) div 4)+10ns,
    	...
    	WaveSetStrobe (C16SHFTCLK_strobeWF,
        	...
        	( (3*t[Tcy]) div 4)+10ns ,
        	( (3*t[Tcy]) div 4)+10ns + 2*t[tShft] );
STOP(ALLTABLES,ALLDEVICES-PJQPack,ALLTESTS,ALLTEMPS);
      end;


STOP(ALLTABLES,ALLDEVICES,ALLTESTS,Temp_N40_Degrees_C);
end else begin	
START(ALLTABLES,ALLDEVICES,ALLTESTS,ALLTEMPS-Temp_N40_Degrees_C);
         WaveSetStrobe (C8DPOUT_strobeWF,
...
STOP(ALLTABLES,ALLDEVICES,ALLTESTS,ALLTEMPS-Temp_N40_Degrees_C);
        end;
...
START(ALLTABLES,ALLDEVICES,ALLTESTS,ALLTEMPS-Temp_125_Degrees_C);
     	WaveSetStrobe (ScanOut_strobeWF,
        	5ns,
        	( (3*t[Tcy]) div 4) - t[tscanout],
        	( (3*t[Tcy]) div 4) + t[tscanout] )
(* APS: Duplicated origins from below so it existed in the same section *)
...
STOP(ALLTABLES,ALLDEVICES,ALLTESTS,ALLTEMPS-Temp_125_Degrees_C);
else
START(ALLTABLES,ALLDEVICES,ALLTESTS,Temp_125_Degrees_C);
      	WaveSetStrobe (ScanOut_strobeWF,
        	( (5*t[Tcy]) div 10),
        	( (75*t[Tcy]) div 100) ,
        	( (75*t[Tcy]) div 100) + 6ns );
        ...
        EdgeSetOriginPinList(ScanOut_strobeWF,Edge2,orgc8,C8_C0);
        EdgeSetOriginPinList(ScanOut_strobeWF,Edge3,orgc8,C8_C0);
STOP(ALLTABLES,ALLDEVICES,ALLTESTS,Temp_125_Degrees_C);
