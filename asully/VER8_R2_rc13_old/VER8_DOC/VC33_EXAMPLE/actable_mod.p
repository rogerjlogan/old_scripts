...
START(TIhifrqloose13DIV2ACTable,TIhifrqloose16DIV2ACTable,ALLENUMS);
...
STOP(TIhifrqloose13DIV2ACTable,TIhifrqloose16DIV2ACTable,ALLENUMS);

          TIhifrqloose10ACTable:;
              begin
START(TIhifrqloose10ACTable,ALLENUMS);
                WaveSetDoubleClk    (CLKINdriveWF,
                                    0ns,
                                    0ns,
                                    (t[tcH]) div 2,
...
STOP(TIhifrqloose10ACTable,ALLENUMS);

          TIhifrqspec13ACTable,
          TIhifrqloose13ACTable:;
              begin
START(TIhifrqspec13ACTable,TIhifrqloose13ACTable,ALLENUMS);
                WaveSetDoubleClk    (CLKINdriveWF,
                                    0ns,
                                    0ns,
                                    (t[tcH]) div 2,
...
STOP(TIhifrqspec13ACTable,TIhifrqloose13ACTable,ALLENUMS);

          TIhifrqspec16ACTable,
          TIhifrqloose16ACTable:;
              begin
START(TIhifrqspec16ACTable,TIhifrqloose16ACTable,ALLENUMS);
                WaveSetDoubleClk    (EXTCLKdriveWF,                   (*** &&&&&&& EXTCLK ADJUSTED FOR DEBUG &&&&&&*)
                                    0.4ns,
                                    1.4ns+2ns,
...
STOP(TIhifrqspec16ACTable,TIhifrqloose16ACTable,ALLENUMS);
              end;

          others:;
             begin
START(ALLTABLES-TIhifrqloose13DIV2ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose10ACTable-TIhifrqspec13ACTable-TIhifrqloose13ACTable-TIhifrqspec16ACTable-TIhifrqloose16ACTable,ALLENUMS);
...
STOP(ALLTABLES-TIhifrqloose13DIV2ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose10ACTable-TIhifrqspec13ACTable-TIhifrqloose13ACTable-TIhifrqspec16ACTable-TIhifrqloose16ACTable,ALLENUMS);
	   end; (* case *)

        case actable of
          TIIDDQACTable:;
START(TIIDDQACTable,ALLENUMS);
            WaveSetEdgeStrobe   (H1strobeWF,
                            0,
                            3ns,
                            9ns);
STOP(TIIDDQACTable,ALLENUMS);

	  TIhifrqloose16DIV2ACTable:;
           begin
START(TIhifrqloose16DIV2ACTable,ALLENUMS);
...
STOP(TIhifrqloose16DIV2ACTable,ALLENUMS);
           end;
...
STOP(TIhifrqloose10ACTable,ALLENUMS);
          ...
          TIhifrqloose16ACTable:;
	   begin
START(TIhifrqloose13ACTable,TIhifrqloose16ACTable,ALLENUMS);
	    WaveSetEdgeStrobe   (H1strobeWF,
			    1.0ns,
			    t[tcCI]+1.5ns+1.5ns,
			    t[tcCI]+4.5ns+1.5ns);
 	    ...
 	    EdgeSetOrigin	(H1strobeWF,Edge2,orgH1L);
	    EdgeSetOrigin	(H1strobeWF,Edge3,orgH1L);
STOP(TIhifrqloose13ACTable,TIhifrqloose16ACTable,ALLENUMS);
           end;

          TIvboxloACTable:;
           begin
START(TIvboxloACTable,ALLENUMS);
            WaveSetEdgeStrobe   (H1strobeWF,
                            0ns,
                            t[tper]-15ns ,
                            t[tper]-10ns ); 
...
STOP(TIvboxloACTable,ALLENUMS);

          TInomlooseACTable:;
           begin 
START(TInomlooseACTable,ALLENUMS);
            WaveSetEdgeStrobe   (H1strobeWF,
                            0ns,
...
STOP(TInomlooseACTable,ALLENUMS);

          TIvboxhiACTable:;
           begin
START(TIvboxhiACTable,ALLENUMS);
            WaveSetEdgeStrobe   (H1strobeWF,
                            0ns,
                            t[tcCI]+3ns,
                            t[tcCI]+8ns);
            ...
            EdgeSetOrigin       (H1strobeWF,Edge2,orgH1L);
            EdgeSetOrigin       (H1strobeWF,Edge3,orgH1L);
STOP(TIvboxhiACTable,ALLENUMS);
           end;

          others:;
           begin
START(ALLTABLES-TIIDDQACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable-TIvboxloACTable-TInomlooseACTable-TIvboxhiACTable,ALLENUMS);
            WaveSetEdgeStrobe   (H1strobeWF,
                            1.0ns,
                            t[tcCI]+2ns,
                            t[tcCI]+5ns);
...
STOP(ALLTABLES-TIIDDQACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable-TIvboxloACTable-TInomlooseACTable-TIvboxhiACTable,ALLENUMS);
...
STOP(TIvboxhiACTable,ALLENUMS);
         ...
         others:;
START(ALLTABLES-TIhifrqloose10ACTable-TIvboxloACTable-TInomlooseACTable-TIvboxhiACTable,ALLENUMS);
            WaveSetEdgeStrobe       (SH1strobeWF,       (* for sync-up *)
                                    0ns,
                                    t[tcCI] - 5ns,
                                    t[tcCI] - 3ns);
STOP(ALLTABLES-TIhifrqloose10ACTable-TIvboxloACTable-TInomlooseACTable-TIvboxhiACTable,ALLENUMS);
...
STOP(TIhifrqloose10ACTable,ALLENUMS);
       ...
       others:;
START(ALLTABLES-TIhifrqloose10ACTable,ALLENUMS);
        WaveSetEdgeStrobe       (SyncH1LstrobeWF,   (* for sync-up *)
                                      0ns,
                                      t[tcH]-12ns,
                                      t[tcH]-6ns);
STOP(ALLTABLES-TIhifrqloose10ACTable,ALLENUMS);
       end;
...
STOP(TIhifrqloose13ACTable,TIhifrqloose16ACTable,ALLENUMS);
          ...
          others:;
           begin
START(ALLTABLES-TIIDDQACTable-TInomlooseACTable-TIvboxhiACTable-TIvboxloACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
            WaveSetEdgeStrobe   (H3strobeWF,
                            0ns,
                            t[tcCI] - 4ns, 
                            t[tcCI] - 1ns);
...
STOP(ALLTABLES-TIIDDQACTable-TInomlooseACTable-TIvboxhiACTable-TIvboxloACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
        end; (* case *)
                            ...
                            8ns);
{
        ...
        if schmoo then
START(ALLTABLES,ALLTEMPS,ALLDEVICES,ALLTESTS,schmoo_on);
          WaveSetNR         (INT_CLKSTPdriveWF,
                            0ns);
STOP(ALLTABLES,ALLTEMPS,ALLDEVICES,ALLTESTS,schmoo_on);
        else
START(ALLTABLES,ALLTEMPS,ALLDEVICES,ALLTESTS,schmoo_off);
          WaveSetNR         (INT_CLKSTPdriveWF,
                            t[tcCI]-t[tsuINTCLKSTP]+dtcf+1ns); (* added 1ns for 10Mhz eval *)
STOP(ALLTABLES,ALLTEMPS,ALLDEVICES,ALLTESTS,schmoo_off);
                                ...
                                0ns,1ns,5ns);
{
	...
	case actable of
          TIIDDQACTable,
	  TIstressACTable:;
START(TIIDDQACTable,TIstressACTable,ALLENUMS);
            WaveSetNR       (TCLKdriveWF,
                             t[tsuTCLK]-1ns); 
STOP(TIIDDQACTable,TIstressACTable,ALLENUMS);

	  others:;
START(ALLTABLES-TIIDDQACTable-TIstressACTable,ALLENUMS);

            WaveSetRTO      (TCLKdriveWF,
                            t[tsuTCLK],
                            (9*t[tcH]) div 10 );
STOP(ALLTABLES-TIIDDQACTable-TIstressACTable,ALLENUMS);
...
STOP(TIvboxloACTable,ALLENUMS);
          others:;
START(ALLTABLES-TIvboxloACTable,ALLENUMS);
            WaveSetStrobe  (TCLKstrobeWF,
                            0ns,
                            t[tdTCLK]+loosetclk+ctcf,
                            t[tdTCLK]+loosetclk+3ns+ctcf);
STOP(ALLTABLES-TIvboxloACTable,ALLENUMS);
       end;
...
STOP(TIvboxhiACTable,ALLENUMS);
          ...
          TIhifrqloose13ACTable:;
             begin
START(TIhifrqloose10ACTable,TIhifrqloose13ACTable,ALLENUMS);
               WaveSetStrobe       (RW_strobeWF,
                                    0ns,
                                    t[tdH1HRWLmax]+ctcf,
...
STOP(TIhifrqloose10ACTable,TIhifrqloose13ACTable,ALLENUMS);
             end;

          TIhifrqloose16ACTable:;
             begin
START(TIhifrqloose16ACTable,ALLENUMS);
               WaveSetStrobe       (RW_strobeWF,
                                    0ns,
                                    t[tdH1HRWLmax]-1.0ns,
               ...
               EdgeSetOrigin       (RW_strobeWF,Edge2,orgH1H);
               EdgeSetOrigin       (RW_strobeWF,Edge3,orgH1H);
STOP(TIhifrqloose16ACTable,ALLENUMS);
             end;

          others:;
START(ALLTABLES-TIvboxloACTable-TInomlooseACTable-TIvboxhiACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
             WaveSetStrobe       (RW_strobeWF,
                                  0ns,
                                  t[tdH1HRWLmax],
                                  t[tdH1HRWLmax]+2ns);
STOP(ALLTABLES-TIvboxloACTable-TInomlooseACTable-TIvboxhiACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
        end;   
...
(* APS moved this to both sections below....
...
STOP(TIIDDQACTable,ALLENUMS);
          others:;
START(ALLTABLES-TIIDDQACTable,ALLENUMS);
        EdgeSetDelayData    (HOLDA_strobeWF,
                            Edge1, ChanFirst,
                            StrobeData, ThreshVITL,
                            t[tcCI]+t[tvHOLDA_]+loosestbdly+2ns-ctcf,0,
            ...
            EdgeSetDelayData  (HOLDA_strobeWF,
			    ...
			    ((9*t[tcH]) div 10 )-ctcf,0,
                            StrobeOff, ThreshVITH,
			    ((9*t[tcH]) div 10 )-ctcf,0);
STOP(ALLTABLES-TIIDDQACTable,ALLENUMS);
        end; (* case *)
...
STOP(TIhifrqloose13ACTable,TIhifrqloose16ACTable,ALLENUMS);
        ...
        others:;
START(ALLTABLES-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
        WaveSetNR       (RDY_driveWF,
                             t[tcCI]);
STOP(ALLTABLES-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
        end;
...
STOP(TIvboxloACTable,ALLENUMS);
          ...
          others:;
            begin
START(ALLTABLES-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable-TIvboxhiACTable-TIvboxloACTable,ALLENUMS);
...
STOP(ALLTABLES-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable-TIvboxhiACTable-TIvboxloACTable,ALLENUMS);
            end;
        end; (* of case *)
...
STOP(ALLTABLES-TIhifrqloose10ACTable,ALLENUMS);
        ...
        case actable of
          TIstressACTable:;
START(TIstressACTable,ALLENUMS);
            WaveSetNR       (DBUSdriveWF,
                            7ns);
STOP(TIstressACTable,ALLENUMS);
          TIIDDQACTable:;
START(TIIDDQACTable,ALLENUMS);
...
STOP(TIhifrqloose10ACTable,ALLENUMS);
	  ...
	  TIhifrqloose13ACTable,
          TIhifrqloose13DIV2ACTable:;
           begin
START(TIhifrqloose16ACTable,TIhifrqloose16DIV2ACTable,TIhifrqloose13ACTable,TIhifrqloose13DIV2ACTable,ALLENUMS);
...
STOP(TIhifrqloose16ACTable,TIhifrqloose16DIV2ACTable,TIhifrqloose13ACTable,TIhifrqloose13DIV2ACTable,ALLENUMS);
           end;

          others:;
            begin
START(ALLTABLES-TIstressACTable-TIstressACTable-TIIDDQACTable-TIhifrqloose10ACTable-TIhifrqloose16ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose13ACTable-TIhifrqloose13DIV2ACTable,ALLENUMS);
...
STOP(ALLTABLES-TIstressACTable-TIstressACTable-TIIDDQACTable-TIhifrqloose10ACTable-TIhifrqloose16ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose13ACTable-TIhifrqloose13DIV2ACTable,ALLENUMS);
           end;
         end; (* end case *)
...
STOP(TIhifrqloose13ACTable,TIhifrqloose16ACTable,ALLENUMS);
           ...
           others:;
             begin
START(ALLTABLES-TIIDDQACTable-TIvboxhiACTable-TInomlooseACTable-TIvboxloACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
               WaveSetStrobe (STRB_strobeWF,
                        t[tcCI] - 2ns,
                        t[tcCI]+t[tdH1LSLmax]+4ns+loosestbdly,
                        t[tcCI]+t[tdH1LSLmax]+5ns+loosestbdly);
...
STOP(ALLTABLES-TIIDDQACTable-TIvboxhiACTable-TInomlooseACTable-TIvboxloACTable-TIhifrqloose10ACTable-TIhifrqloose13ACTable-TIhifrqloose16ACTable,ALLENUMS);
           end; (* end case *)
...
STOP(TIIDDQACTable,ALLENUMS);
	  ...
	  TIhifrqloose13ACTable,
          TIhifrqloose13DIV2ACTable:;
           begin
START(TIhifrqloose10ACTable,TIhifrqloose16ACTable,TIhifrqloose16DIV2ACTable,TIhifrqloose13ACTable,TIhifrqloose13DIV2ACTable,ALLENUMS);
            WaveSetRTO     (XFdriveWF,t[tcCI]-t[tsuXF], t[tcCI]);



STOP(TIhifrqloose10ACTable,TIhifrqloose16ACTable,TIhifrqloose16DIV2ACTable,TIhifrqloose13ACTable,TIhifrqloose13DIV2ACTable,ALLENUMS);
          end;
          others:;
START(ALLTABLES-TIstressACTable-TIIDDQACTable-TIhifrqloose10ACTable-TIhifrqloose16ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose13ACTable-TIhifrqloose13DIV2ACTable,ALLENUMS);
        WaveSetNR           (XFdriveWF,
                            20ns);


STOP(ALLTABLES-TIstressACTable-TIIDDQACTable-TIhifrqloose10ACTable-TIhifrqloose16ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose13ACTable-TIhifrqloose13DIV2ACTable,ALLENUMS);
        end; (* case *)
...
STOP(TInomlooseACTable,ALLENUMS);
           ...
           begin
START(ALLTABLES-TInomlooseACTable,ALLENUMS);
...
STOP(ALLTABLES-TInomlooseACTable,ALLENUMS);
           end;
...
START(ALLTABLES-TIstressACTable,ALLENUMS);
          WaveSetSBC        (XF1SIGIdriveWF,
			    0ns,
                            t[tcCI]-t[tsuXF1SIGI]-loosesetup+dtcf,
                            t[tcCI]+t[thXF1SIGI]+loosehold-dtcf);
STOP(ALLTABLES-TIstressACTable,ALLENUMS);
...
START(TIhifrqloose13ACTable,ALLENUMS);
               WaveSetStrobe       (CLKXstrobeWF,
                                   t[tdH1HCLKX]-2ns,
                                   t[tdH1HCLKX]+3ns,
                                   t[tdH1HCLKX]+6ns)
STOP(TIhifrqloose13ACTable,ALLENUMS);

        else
START(ALLTABLES-TIhifrqloose10ACTable-TIhifrqloose13ACTable,ALLENUMS);
               WaveSetStrobe       (CLKXstrobeWF,
                                   t[tdH1HCLKX]+loosestbdly-2ns,
                                   t[tdH1HCLKX]+loosestbdly+1ns,
                                   t[tcCI]);
STOP(ALLTABLES-TIhifrqloose10ACTable-TIhifrqloose13ACTable,ALLENUMS);
...
START(ALLTABLES,ALLTEMPS,ALLDEVICES,Probe,schmoo_on,schmoo_off);
          EdgeSet 	    (FSXbdriveWF, Edge1, DriveLow,
			     t[tdH1HCLKX] + t[thEFSXCLKXL]+3ns +dtcf)
        EdgeSetOrigin	    (FSXbdriveWF,Edge1,orgtdH1HCLKXL);
STOP(ALLTABLES,ALLTEMPS,ALLDEVICES,Probe,schmoo_on,schmoo_off);
        else
START(ALLTABLES,ALLTEMPS,ALLDEVICES,ALLTESTS-Probe,schmoo_on,schmoo_off);
          EdgeSet 	    (FSXbdriveWF, Edge1, DriveLow,
			     t[tdH1HCLKX] + t[thEFSXCLKXL] +dtcf);
        EdgeSetOrigin	    (FSXbdriveWF,Edge1,orgtdH1HCLKXL);
STOP(ALLTABLES,ALLTEMPS,ALLDEVICES,ALLTESTS-Probe,schmoo_on,schmoo_off);
(*APS:; moved up        EdgeSetOrigin	    (FSXbdriveWF,Edge1,orgtdH1HCLKXL); *)
...
STOP(TIhifrqloose10ACTable,ALLENUMS);
        ...
        others:;
          begin
START(ALLTABLES-TInomlooseACTable-TIhifrqloose10ACTable,ALLENUMS);
           WaveSetStrobe       (DXstrobeWF,
                               0ns,
                               t[tdCLKXHDX]+2ns, 
                               t[tdCLKXHDX]+5ns); 
	   ...
	   EdgeSetOrigin	    (DXstrobeWF,Edge2,orgtdH1HCLKXH);	
     	   EdgeSetOrigin	    (DXstrobeWF,Edge3,orgtdH1HCLKXH);	
STOP(ALLTABLES-TInomlooseACTable-TIhifrqloose10ACTable,ALLENUMS);
          end;
       end; (* end case *)
...
STOP(TIhifrqloose10ACTable,ALLENUMS);
            others:;
START(ALLTABLES-TIstressACTable-TIhifrqloose10ACTable,ALLENUMS);
              WaveSetSBC	    (EXDRdrive2WF,
	               		     3*t[tcH] div 4 + t[tECLKRLduty] -
			             ...
			             3*t[tcH] div 4 + t[tECLKRLduty] +
                                             t[thDRECLKRL] - dtcf);
STOP(ALLTABLES-TIstressACTable-TIhifrqloose10ACTable,ALLENUMS);
        end;
...
STOP(TIhifrqloose10ACTable,ALLENUMS);
          ...
          others:;
          begin
START(ALLTABLES-TIIDDQACTable-TIhifrqloose10ACTable,ALLENUMS);
            EdgeSet            (EXTDRdrive2WF,Edge1,DriveData,
                                t[tcH] div 4 + t[tECLKRLduty] -
            ...
            EdgeSet            (EXTDRdrive2WF,Edge2,DriveComplement,
                                t[tcH] div 4 + t[tECLKRLduty] +
                                t[thDRECLKRL] - dtcf);
STOP(ALLTABLES-TIIDDQACTable-TIhifrqloose10ACTable,ALLENUMS);
          end;
        end; (* case *)
...
STOP(TIhifrqloose10ACTable,ALLENUMS);
          others:;
START(ALLTABLES-TIIDDQACTable-TIhifrqloose16ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose13ACTable-TIhifrqloose13DIV2ACTable-TIhifrqloose10ACTable,ALLENUMS);
            WaveSetNR	    (EXFSRVdrive2WF,
			    3*t[tcH] div 4 + t[tECLKRLduty] -
                                             t[tsuFSRECLKRL] - 27ns + dtcf +21ns); (* added +21ns for 10mhz Eval *)
STOP(ALLTABLES-TIIDDQACTable-TIhifrqloose16ACTable-TIhifrqloose16DIV2ACTable-TIhifrqloose13ACTable-TIhifrqloose13DIV2ACTable-TIhifrqloose10ACTable,ALLENUMS);
        end; (* end case *)
