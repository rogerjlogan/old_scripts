...
int process_waveforms(FILE *fpwaves,int *fmtcnt,int *which,char *pin,int used_line[],int DSET,int CNT,char *tperiod,int *code0,int *code1) {
   ...
   char org1[WF_EXPR_LEN],org2[WF_EXPR_LEN],org3[WF_EXPR_LEN],org4[WF_EXPR_LEN];
   char *name,*ptr0,*ptr1,*ptr1C,*tptr,*pelse,field[20][WF_EXPR_LEN],type[WF_EXPR_LEN],copybuf[1000],dupwarn[WF_EXPR_LEN],hold;
